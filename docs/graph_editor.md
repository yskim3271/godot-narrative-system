...
| 그 외 필드 편집 | 노드 클릭 → **Inspector**에서 조건/액션/선택지/시퀀스 등 편집 (❓⚡🎬 배지로 표시) |
...
- 선택지의 텍스트·타깃은 아직 인라인 편집 불가 — Inspector에서 편집 후 Refresh(연결은 포트 드래그로도 변경 가능)
- 인라인 편집은 화자/텍스트/노드 id에 한정 — 조건/액션/시퀀스는 Inspector
